...
public final class O0000000O0O0O extends Event {
   private final MinecraftClient O00000000;
   private final Instant O000000000;

   public O0000000O0O0O(MinecraftClient minecraftClient) {
      this(minecraftClient, Instant.now());
   }

   public O0000000O0O0O(MinecraftClient minecraftClient, Instant instant) {
